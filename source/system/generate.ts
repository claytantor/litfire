...
const INSTRUCTION = [
	...
	'',
	'### A ceiling that moves',
	'',
	'`{alpha}/{alpha-max}` is a screen saying the cap is a number the world',
	'tracks rather than a constant — almost always because it rises as a',
	'character grows. Write it as a derived stat and point the stat it caps at',
	'it:',
	'',
	'```yaml',
	'stats:',
	...
	'```',
	'',
	'`max_from` is what makes the ceiling a rule rather than a decoration: the',
	'checks report a character above it. Use `max:` instead only when the bound',
	'never moves, and neither when the author has not said there is one.',
	'',
	'Where their text gives a table of levels and limits, that table is the',
	'formula and its numbers are not yours to adjust.',
	'',
