...
A moment is a point on this clock, and creating or re-timing one is
[its own topic](../guide/moments.md). The short version:

```
/moment new The Substrate Patch
/moment the-substrate-patch at 2036-08-15 02:30:00
```
