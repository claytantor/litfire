...
| Deferral                                        | State                                 |
| ----------------------------------------------- | ------------------------------------- |
| Native Ink prose buffer (§10)                   | done; writes situations too (D7)      |
...
Per the [genre reference](../concepts/litrpg.md) §6 step 6, Slice 2 is **assembly** — ordering, reconciling,
...
Committed answers to the §14 open decisions are in [Committed decisions](./decisions.md).
